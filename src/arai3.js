...
var $author$project$Arai3$init = function (_v0) {
	return _Utils_Tuple2(
		{
			conf: _List_fromArray(
				[
					{d: 4, oldx: 0, oldy: 0, x: 3, y: 2},
					{d: 4, oldx: 0, oldy: 0, x: 2, y: 2},
					{d: 2, oldx: 0, oldy: 0, x: 2, y: 3},
					{d: 2, oldx: 0, oldy: 0, x: 1, y: 1}
				]),
			gameOver: false,
			startAt: {x: 0, y: 0}
		},
...
var $author$project$Arai3$subscriptions = function (model) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Arai3$RandAdd = function (a) {
	return {$: 'RandAdd', a: a};
};
...
var $author$project$Arai3$rmDup = function (line) {
	var t = A2($elm$core$List$drop, 1, line);
	var n = A2(
		$elm$core$Maybe$withDefault,
		{d: 1, oldx: 0, oldy: 0, x: 0, y: 0},
		$elm$core$List$head(t));
	var h = A2(
		$elm$core$Maybe$withDefault,
		{d: 0, oldx: 0, oldy: 0, x: 0, y: 0},
		$elm$core$List$head(line));
	return (!$elm$core$List$length(line)) ? _List_Nil : ((!$elm$core$List$length(t)) ? _List_fromArray(
		[h]) : ((_Utils_eq(h.d, n.d) && ($elm$core$Basics$abs((h.x - n.x) + (h.y - n.y)) === 1)) ? $elm$core$List$concat(
		_List_fromArray(
			[
				_List_fromArray(
				[
				...
				$author$project$Arai3$rmDup(
				A2($elm$core$List$drop, 1, t))
			])) : $elm$core$List$concat(
		_List_fromArray(
			[
				_List_fromArray(
				[h]),
				$author$project$Arai3$rmDup(t)
			]))));
};
var $elm$core$List$sortBy = _List_sortBy;
var $author$project$Arai3$moveDown = function (col) {
	var sorted = $author$project$Arai3$rmDup(
		...
		F2(
			function (idx, digit) {
				return _Utils_update(
					digit,
					{oldx: digit.x, oldy: digit.y, y: 3 - idx});
			}),
		sorted);
};
...
var $author$project$Arai3$splitX = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'splitx:',
		A2(
			...
			function (x) {
				return A2(
					...
					function (digit) {
						return _Utils_eq(digit.x, x);
					},
					conf);
			},
			A2($elm$core$List$range, 0, 3)));
};
var $author$project$Arai3$down = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'down:',
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$author$project$Arai3$moveDown,
				$author$project$Arai3$splitX(conf))));
};
...
var $author$project$Arai3$adjSameColor = F2(
	function (p, q) {
		return ((($elm$core$Basics$abs(p.x - q.x) + $elm$core$Basics$abs(p.y - q.y)) === 1) && _Utils_eq(p.d, q.d)) ? true : false;
	});
var $author$project$Arai3$isMovable = function (model) {
	return ($elm$core$List$length(model.conf) < 16) || A3(
		$elm$core$List$foldl,
		F2(
			function (p, b) {
				return b || A3(
					...
					F2(
						function (q, found) {
							return found || A2($author$project$Arai3$adjSameColor, p, q);
						}),
					false,
					model.conf);
			}),
...
var $author$project$Arai3$moveLeft = function (row) {
	var sorted = $author$project$Arai3$rmDup(
		A2(
			$elm$core$List$sortBy,
			function ($) {
	...
	return A2(
		...
		F2(
			function (idx, digit) {
				return _Utils_update(
					digit,
					{oldx: digit.x, oldy: digit.y, x: idx});
			}),
		sorted);
};
var $author$project$Arai3$splitY = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'splity:',
		A2(
			...
			function (y) {
				return A2(
					$elm$core$List$filter,
					function (digit) {
						return _Utils_eq(digit.y, y);
					},
					conf);
			},
			A2($elm$core$List$range, 0, 3)));
};
var $author$project$Arai3$left = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'left:',
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$author$project$Arai3$moveLeft,
				$author$project$Arai3$splitY(conf))));
};
var $elm$core$Basics$ge = _Utils_ge;
var $author$project$Arai3$find = F2(
	function (coord, model) {
		return $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (m) {
					return _Utils_eq(coord.x, m.x) && _Utils_eq(coord.y, m.y);
				},
				model.conf)) >= 1;
	});
var $elm$core$Basics$not = _Basics_not;
var $author$project$Arai3$put = F3(
	function (digit, place, model) {
		var full = $elm$core$List$concat(
			A2(
				$elm$core$List$map,
				function (x) {
					return A2(
		...
		var rest = A2(
			$elm$core$List$filter,
			function (c) {
				return !A2($author$project$Arai3$find, c, model);
			},
			full);
		var coord = A2(
			$elm$core$Maybe$withDefault,
			{x: 0, y: 0},
			$elm$core$List$head(
				A2($elm$core$List$drop, place - 1, rest)));
		return _Utils_update(
			model,
			{
				conf: A2(
					$elm$core$List$cons,
					{d: digit, oldx: 0, oldy: 0, x: coord.x, y: coord.y},
					model.conf)
			});
	});
var $author$project$Arai3$moveRight = function (row) {
	var sorted = $author$project$Arai3$rmDup(
		$elm$core$List$reverse(
			A2(
				$elm$core$List$sortBy,
	...
	return A2(
		...
		F2(
			function (idx, digit) {
				return _Utils_update(
					digit,
					{oldx: digit.x, oldy: digit.y, x: 3 - idx});
			}),
		sorted);
};
var $author$project$Arai3$right = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'right:',
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$author$project$Arai3$moveRight,
				$author$project$Arai3$splitY(conf))));
};
...
var $author$project$Arai3$sound = _Platform_outgoingPort('sound', $elm$core$Basics$identity);
var $author$project$Arai3$moveUp = function (col) {
	var sorted = $author$project$Arai3$rmDup(
		A2(
			$elm$core$List$sortBy,
			function ($) {
	...
	return A2(
		...
		F2(
			function (idx, digit) {
				return _Utils_update(
					digit,
					{oldx: digit.x, oldy: digit.y, y: idx});
			}),
		sorted);
};
var $author$project$Arai3$up = function (conf) {
	return A2(
		$elm$core$Debug$log,
		'up:',
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$author$project$Arai3$moveUp,
				$author$project$Arai3$splitX(conf))));
};
var $author$project$Arai3$update = F2(
	function (msg, model) {
		if ($author$project$Arai3$isMovable(model)) {
			switch (msg.$) {
				case 'RandAdd':
					var place = msg.a;
					return _Utils_Tuple2(
						A3($author$project$Arai3$put, 2, place, model),
						$author$project$Arai3$sound(
							$elm$json$Json$Encode$bool(true)));
				case 'PDown':
					var event = msg.a;
					var py = event.pointer.offsetPos.b;
					var px = event.pointer.offsetPos.a;
					var dummy = A2(
						$elm$core$Debug$log,
						'Down',
						_Utils_Tuple2(px, py));
				...
				default:
					var event = msg.a;
					var py = event.pointer.offsetPos.b;
					var vy = py - model.startAt.y;
					var px = event.pointer.offsetPos.a;
					var vx = px - model.startAt.x;
					return ((vx > 0) && ((_Utils_cmp(vx, vy) > 0) && ((_Utils_cmp(vy, -vx) > 0) && ($elm$core$List$length(
						$author$project$Arai3$right(model.conf)) < 16)))) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								conf: $author$project$Arai3$right(model.conf)
							}),
						A2(
							$elm$random$Random$generate,
							$author$project$Arai3$RandAdd,
							A2(
								$elm$random$Random$int,
								1,
								16 - $elm$core$List$length(
									$author$project$Arai3$right(model.conf))))) : (((vx < 0) && ((_Utils_cmp(vx, vy) < 0) && ((_Utils_cmp(vy, -vx) < 0) && ($elm$core$List$length(
						$author$project$Arai3$left(model.conf)) < 16)))) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								conf: $author$project$Arai3$left(model.conf)
							}),
						A2(
							$elm$random$Random$generate,
							$author$project$Arai3$RandAdd,
							A2(
								...
								1,
								16 - $elm$core$List$length(
									$author$project$Arai3$left(model.conf))))) : (((vy > 0) && ((_Utils_cmp(vy, vx) > 0) && ((_Utils_cmp(vy, -vx) > 0) && ($elm$core$List$length(
						$author$project$Arai3$down(model.conf)) < 16)))) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								conf: $author$project$Arai3$down(model.conf)
							}),
						A2(
							$elm$random$Random$generate,
							$author$project$Arai3$RandAdd,
							A2(
								...
								1,
								16 - $elm$core$List$length(
									$author$project$Arai3$down(model.conf))))) : (((vy < 0) && ((_Utils_cmp(vy, vx) < 0) && ((_Utils_cmp(vy, -vx) < 0) && ($elm$core$List$length(
						$author$project$Arai3$up(model.conf)) < 16)))) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{
								conf: $author$project$Arai3$up(model.conf)
							}),
						A2(
							$elm$random$Random$generate,
							$author$project$Arai3$RandAdd,
							A2(
								...
								1,
								16 - $elm$core$List$length(
									$author$project$Arai3$up(model.conf))))) : _Utils_Tuple2(
						_Utils_update(
							model,
							{gameOver: true}),
						$elm$core$Platform$Cmd$none))));
...
var $author$project$Arai3$PDown = function (a) {
	return {$: 'PDown', a: a};
};
var $author$project$Arai3$PUp = function (a) {
	return {$: 'PUp', a: a};
};
...
var $author$project$Arai3$cell = function (pos) {
	return A2(
		$elm$svg$Svg$rect,
		_List_fromArray(
			[
				$elm$svg$Svg$Attributes$x(
				$elm$core$String$fromInt(pos.x * 50)),
				$elm$svg$Svg$Attributes$y(
				$elm$core$String$fromInt(pos.y * 50)),
...
var $author$project$Arai3$myOnDown = A2(
...
var $author$project$Arai3$animatedSvg = $andrewMacmurray$elm_simple_animation$Simple$Animation$Animated$svg(
	{_class: $elm$svg$Svg$Attributes$class});
var $elm$svg$Svg$g = $elm$svg$Svg$trustedNode('g');
var $author$project$Arai3$animatedG = $author$project$Arai3$animatedSvg($elm$svg$Svg$g);
...
var $author$project$Arai3$fadeOut = F4(
	function (x, y, oldx, oldy) {
		return A3(
			...
			_List_fromArray(
				[
					...
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(oldx * 50),
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(oldy * 50)
				]),
			_List_fromArray(
				[
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$opacity(1),
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$x(x * 50),
					$andrewMacmurray$elm_simple_animation$Simple$Animation$Property$y(y * 50)
				]));
	});
...
var $author$project$Arai3$panel = function (digit) {
	var color = function () {
		var _v0 = digit.d;
		switch (_v0) {
			case 2:
	...
	return A3(
		$author$project$Arai3$animatedG,
		A4($author$project$Arai3$fadeOut, digit.x, digit.y, digit.oldx, digit.oldy),
		_List_Nil,
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$svg$Svg$text(
						$elm$core$String$fromInt(digit.d))
					]))
			]));
};
...
var $author$project$Arai3$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						function (event) {
							return $author$project$Arai3$PUp(event);
						}),
							...
							A2(
								...
								function (x) {
									return A2(
										$elm$core$List$map,
										function (y) {
											return $author$project$Arai3$cell(
												{x: x, y: y});
										},
										A2($elm$core$List$range, 0, 3));
								},
								A2($elm$core$List$range, 0, 3))),
							A2($elm$core$List$map, $author$project$Arai3$panel, model.conf),
							_List_fromArray(
							[
								A2(
								$elm$svg$Svg$text_,
...
var $author$project$Arai3$main = $elm$browser$Browser$element(
	{init: $author$project$Arai3$init, subscriptions: $author$project$Arai3$subscriptions, update: $author$project$Arai3$update, view: $author$project$Arai3$view});
_Platform_export({'Arai3':{'init':$author$project$Arai3$main(
